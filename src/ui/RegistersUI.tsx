    ...
    <div className="flex flex-column bg-blue-100 p-2 gap-2">
      ...
      <div className="flex flex-row gap-2">
        ...
        <div className="flex flex-column text-center w-2rem">
          ...
          <span className={getClass(ctrl, compState, ["hi(PC)", "PC"])}>{fprint(compState.regs[6], format)}</span>
          <span className={getClass(ctrl, compState, ["hi(SP)", "SP"])}>{fprint(compState.regs[8], format)}</span>
        </div>
        <div className="flex flex-column text-center w-2rem">
          ...
          <span className={getClass(ctrl, compState, ["lo(PC)", "PC"])}>{fprint(compState.regs[7], format)}</span>
          <span className={getClass(ctrl, compState, ["lo(SP)", "SP"])}>{fprint(compState.regs[9], format)}</span>
        </div>
